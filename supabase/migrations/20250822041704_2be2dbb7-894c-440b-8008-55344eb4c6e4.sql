-- Fix security issue: Add RLS policies and make user_id required

-- First, make user_id columns NOT NULL (required for proper RLS)
-- Note: This requires existing data to have user_id values
